...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2022 at 09:26 PM
...
(1, 'admin', 'admin', 0, '', '', 1),
(3, 'vishal', 'vishal', 1, 'vishal@gmail.com', '8691931862', 1),
(4, 'sufi', 'sufi', 1, 'sufi@gmail.com', '8691931862', 1);
...
(1, 14, 'mumbai', 'maharashtra', 400003, 'COD', 900, 'success', 1, 0, '', '', '2022-04-18 12:00:34'),
(2, 14, 'edeokdoe', 'maharashtra', 401107, 'COD', 4499, 'success', 1, 0, '', '', '2022-04-18 03:04:19');
...
INSERT INTO `product` (`id`, `categories_id`, `sub_categories_id`, `name`, `mrp`, `price`, `qty`, `image`, `short_decs`, `description`, `best_seller`, `meta_title`, `meta_desc`, `meta_keyword`, `added_by`, `status`) VALUES
(11, 13, 10, 'OPPO', 15000, 12999, 2, '661015055_opp.png', 'OPPO A11 RAM 4GB ROM 64GB', 'OPPO A11 RAM 4GB ROM 64GB OPPO Mobile Battery 6000mh', 0, 'electronics product', 'OPPO A11 RAM 4GB ROM 64GB OPPO Mobile Battery 6000mh electronics product', 'electronics product', 0, 1),
(12, 14, 5, 'Watch mi3', 2000, 1499, 3, '692512908_mi3.jpg', 'Digital watch mi3', 'Digital watch mi3 RAM 2GB ROM 16GB', 0, 'Digital watch mi3 RAM 2GB ROM 16GB', 'Digital watch mi3 RAM 2GB ROM 16GB Band Watch', 'Digital watch mi3 RAM 2GB ROM 16GB Band Watch electronic', 0, 1),
(13, 14, 5, 'Watch mi2', 2000, 1599, 6, '229054572_mi2.jpg', 'Digital watch mi2', 'Digital watch mi2 RAM 2GB ROM 16GB Band Watch', 0, 'Digital watch mi2 RAM 2GB ROM', 'Digital watch mi2 RAM 2GB ROM 16GB', 'Digital watch mi2 RAM 2GB ROM 16GB Band Watch', 0, 1),
(14, 13, 13, 'Realme', 20000, 17999, 5, '895318591_rel.png', 'Realme x7 RAM 6GB ROM 64GB', 'RAM 4GB ROM 64GB Realme Mobile Battery 6000mh 5G Supported', 0, 'RAM 4GB ROM 64GB Realme Mobile Battery 6000mh 5G Supported', 'RAM 4GB ROM 64GB Realme Mobile Battery 6000mh 5G Supported 128GB External Supported', 'RAM 4GB ROM 64GB Realme Mobile Battery 6000mh 5G Supported', 0, 1),
...
(22, 11, 1, 'shoes', 400, 349, 6, '761814371_aac-9064-7-tying-gray-original-imafz5dzkmtxmv69.jpeg', 'grey and white shoe', 'grey and white shoe', 1, 'grey and white shoe all size are available', 'grey and white shoe all size are available', 'grey and white shoe all size are available', 0, 1),
...
(24, 11, 3, 'Black Tshirt', 1000, 699, 6, '653413773_931830512__8-(1)-E5x-104831-NJD.jpg', 'tshirt', 'tshirt', 0, 'tshirt', 'tshirt', 'tshirt', 0, 1),
...
(30, 12, 7, 'Half Seleves t-shirt', 650, 399, 5, '676099203_309027777_Floral-Print-Polo-T-shirt.jpg', 'Black T-shirt,three color are availabel', 'Black T-shirt,three color are availabel and all size are avilabel', 0, 'Black T-shirt,three color are availabel and all size are avilabel', 'Black T-shirt,three color are availabel and all size are avilabel', 'Black T-shirt,three color are availabel and all size are avilabel', 0, 1),
...
(34, 12, 8, 'Lace Casual Boots For Girl(White)', 3000, 1999, 5, '585733619_pr13.png', 'Lace Casual Boots For Girl(White)', 'Lace Casual Boots For Girl(White)', 1, 'Lace Casual Boots For Girl(White)', 'Lace Casual Boots For Girl(White)', 'Lace Casual Boots For Girl(White)', 0, 1),
...
(37, 14, 5, 'ladies watch', 500, 399455, 5, '703893585_6-ccrr1-blk-6-absolute-comfort-black-white-original-imag6tkuzjkgfhvf.jpeg', 'fossil', 'fossil', 1, 'fossil watch', '', 'foss', 0, 1),
(38, 15, 14, 'dumbell', 1000, 900, 5, '602693742_sports-product5.jpg', 'dumbell', 'dumbell', 0, 'dumbell', 'dumbell', 'dumbell', 3, 1),
(39, 11, 1, 'shoes sparx', 1000, 900, 8, '483020554_spcy707-10-magnolia-green-original-imafthkf5gf4yzey.jpeg', 'shoes', 'shoes', 1, 'shoes', 'shoes', 'shoes', 3, 1);
